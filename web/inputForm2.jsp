...
<html>
    <head>
        ...
        <title>Simple Formula Calculators, Challenge 2</title>
    ...
    <body>
    <center><h1>Simple Formula Calculators, Challenge 2</h1></center>
    <p>Area of a Rectangle</p>
    <form id="form1" name="form1" method="POST" action="mainServlet2">
        ...
        <p><%
                Object obj = request.getAttribute("answerRect");
                String answer = "";
                if(obj != null) {
                    answer = obj.toString();
                }
    ...
    <form id="form2" name="form2" method="POST" action="mainServlet2">
        ...
        <p><%
                obj = request.getAttribute("answerCirc");
                answer = "";
                if(obj != null) {
                    answer = obj.toString();
                }
    ...
    <form id="form3" name="form3" method="POST" action="mainServlet2">
        ...
        <p><%
                obj = request.getAttribute("answerTri1");
                answer = "";
                if(obj != null) {
                    answer = obj.toString();
                }
        ...
        <p><%
                obj = request.getAttribute("answerTri2");
                answer = "";
                if(obj != null) {
                    answer = obj.toString();
                }
